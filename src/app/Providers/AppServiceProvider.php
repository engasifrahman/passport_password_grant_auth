...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Enable the password grant for Passport
        Passport::enablePasswordGrant();

        // Set Passport's token expiration times
        Passport::tokensExpireIn(CarbonInterval::days(config('passport.token-expiration', 30)));
        Passport::refreshTokensExpireIn(CarbonInterval::days(config('passport.refresh-token-expiration', 30)));
